...
The approach take in Dynamical Network Analysis is one based on the corelation of movement of representative atoms (or *nodes*), such as alpha-carbons of amino acid residues. This serves as a measurement to determine the existence and strength of a link between different atoms or molecules of a system. 
...
After determining all nodes in contact throughout a simulation, and calculating the correlation of motion between them, the network can then be visualized (see :ref:`Image 1 <FigNetwork>`).
